...
def propagate_to_edge(x, edge, radius=5, beta=10, exp_times=8, name=None, path4graph4gcn=None):
    ...
    if name != None:
        print("Graph")
        print(os.path.join(path4graph4gcn, name))
        np.save(os.path.join(path4graph4gcn, name), trans_mat.cpu().numpy())
